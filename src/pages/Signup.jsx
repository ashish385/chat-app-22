              ...
              <div className="flex flex-col gap-2 px-4">
                <div className="w-full flex justify-between">
                  <input
                    ...
                    className=" w-[48%] px-3 py-[.39rem] text-sm border-[1.5px] rounded-md outline-none focus:ring-[1px] ring-gray-400 focus:text-gray-800"
                  />
                  <input
                    type="text"
                    name="lastName"
                    ...
                    className="peer w-[48%] px-3 py-[.39rem] border rounded-md outline-none focus:ring-1 ring-gray-400 focus:text-gray-800"
                  />
                </div>
                <label htmlFor="number">
                  <input
                    ...
                    className="peer w-full px-3 py-[.39rem]  border-[1.5px] rounded-md outline-none focus:ring-1 ring-gray-400 focus:text-gray-800"
                  />
                </label>
